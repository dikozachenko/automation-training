...
public class HomePage {
    ...
    public ResultSearchPage searchHotelsByParameters(SearchQuery query) {
        ...
        new WebDriverWait(driver, WAIT_TIMEOUT_SECOND).until(ExpectedConditions.presenceOfElementLocated(By.xpath(XPATH_FOR_ARRIVAL_DATE)));
        arrivalDate.sendKeys(query.getArrivalDate());
        new WebDriverWait(driver, WAIT_TIMEOUT_SECOND).until(ExpectedConditions.presenceOfElementLocated(By.xpath(XPATH_FOR_DEPARTURE_DATE)));
